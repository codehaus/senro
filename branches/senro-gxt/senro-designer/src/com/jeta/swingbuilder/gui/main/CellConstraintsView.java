...
public class CellConstraintsView extends JETAPanel implements GridViewListener
{
   ...
   {
      return new ReadOnlyConstraints( getColumn(),
				      getRow(),
				      getColumnSpan(),
				      getRowSpan(), 
   ...
   {
      return new Insets( getInteger( CellConstraintsNames.ID_INSETS_TOP, 0 ),
			 getInteger( CellConstraintsNames.ID_INSETS_LEFT, 0 ),
			 getInteger( CellConstraintsNames.ID_INSETS_BOTTOM, 0 ),
			 getInteger( CellConstraintsNames.ID_INSETS_RIGHT, 0 ) );
   }
   ...
   /**
    * Updates the panel using the constraint info from the currently selected cell in the given editor
    */
