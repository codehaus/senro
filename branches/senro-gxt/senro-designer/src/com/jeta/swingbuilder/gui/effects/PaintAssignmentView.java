...
/**
 * Displays the fill effects view.  Currently we support
 * solid, gradient, and texture fills for panels and cells.
 * @author Jeff Tassin
 */
public class PaintAssignmentView extends JETAPanel
{
   ...
   void loadView( Class viewClass )
   {
	 ...
	 {
	    FormPanel.removeFromParent( (java.awt.Component)m_current_view.getView() );
	    }*/
   ...
   private static class PaintViewProxy implements PaintView, JETARule
   {
	 ...
	 m_validator = viewValidator;
      ...
      public PaintView getView() { return m_view; }
