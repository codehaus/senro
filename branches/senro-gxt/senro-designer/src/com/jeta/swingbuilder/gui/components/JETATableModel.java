...
public class JETATableModel extends AbstractTableModel
{
    ...
    * @param tableId the id of the table we are displaying the indices for
    */
   ...
   /**
    * @return the index of the given object if it is contained in this model.  -1 is
    * returned if this model does not contain the object. 
    */
