...
/**
 * This component renders the grid lines on a form in the designer.
 * This class is also responsible for drawing the blue selection rectangle
 * for a selected component in the designer.
 *
 * @author Jeff Tassin
 */
public class DesignGridOverlay extends JPanel implements GridCellListener, GridOverlay
{
   ...
   /**
    * Flag that indicates if the grid is visible or not.  We don't use the setVisible/isVisible method
    * of Component because the selected cell won't be repainted.
    */
    ...
    * @param view the GridView that contains this overlay.
    */
   ...
   /**
    * Paints a small icon on the grid cell if the GridComponent is too small to be seen
    */
   ...
   /**
    * Override updateUI so we can update the grid lines color.  It should be
    * one shade darker than the current component background color.  This
    * method is invoked when the look and feel changes in the designer.
    */
