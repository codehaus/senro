...
public class PropertyTableModel extends AbstractTableModel
{
     ...
     * editor is not specified in the property descriptor then it is looked up in
        ...
        if (cls != null) {
            ...
            if (type != null) {
                ...
                if (editor == null) {
                    ...
                    /**
                     * The property editor manager will return default editors for
                     * the Java primitives. Everything else is up to the application.
                     */
                ...
                // System.out.println( "PropertyEditorManager returned: " + editor +
                // " for type: " + type );
    ...
    private static void registerPropertyEditors()
    {
        ...
        PropertyEditorManager.registerEditor(Boolean.class,
                com.jeta.swingbuilder.gui.properties.editors.BooleanEditor.class);
        PropertyEditorManager.registerEditor(boolean.class,
                com.jeta.swingbuilder.gui.properties.editors.BooleanEditor.class);
        PropertyEditorManager.registerEditor(String.class,
                com.jeta.swingbuilder.gui.properties.editors.StringEditor.class);
        PropertyEditorManager.registerEditor(Dimension.class,
                com.jeta.swingbuilder.gui.properties.editors.DimensionEditor.class);
        PropertyEditorManager.registerEditor(Icon.class, com.jeta.swingbuilder.gui.properties.editors.IconEditor.class);

        PropertyEditorManager.registerEditor(byte.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.ByteEditor.class);

        PropertyEditorManager.registerEditor(short.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.ShortEditor.class);
        PropertyEditorManager.registerEditor(Short.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.ShortEditor.class);

        PropertyEditorManager.registerEditor(int.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.IntegerEditor.class);
        PropertyEditorManager.registerEditor(Integer.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.IntegerEditor.class);

        PropertyEditorManager.registerEditor(long.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.LongEditor.class);
        PropertyEditorManager.registerEditor(Long.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.LongEditor.class);

        PropertyEditorManager.registerEditor(float.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.FloatEditor.class);
        PropertyEditorManager.registerEditor(Float.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.FloatEditor.class);

        PropertyEditorManager.registerEditor(double.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.DoubleEditor.class);
        PropertyEditorManager.registerEditor(Double.class,
                com.jeta.swingbuilder.gui.properties.editors.NumericEditor.DoubleEditor.class);
