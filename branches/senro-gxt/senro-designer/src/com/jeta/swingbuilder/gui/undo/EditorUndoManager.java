...
public class EditorUndoManager extends CompoundEdit
{
   ...
   public void undoHappened( FormEditor editor, FormUndoableEdit edit )
   {
	 ...
	 undo( false );
      ...
      {
	 /**
	  * We need to lock all edits with the same form id because we are not out of
	  * sync with the other editor.  This can happen if we delete a nested form with edits from this editor
	  * and edit that form in aonther edit.
	  */
    ...
    * @param shouldUndo flag that indicates if the undo on the edit should be invoked.
    * If false, this operation only changes the indexOfNextAdd pointer.
    */
    ...
    * @param shouldRedo flag that indicates if the redo on the edit should be invoked.
    * If false, this operation only changes the indexOfNextAdd pointer.
    */
