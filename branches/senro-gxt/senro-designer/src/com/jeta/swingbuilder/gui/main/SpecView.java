...
import com.jeta.forms.store.memento.FormGroup;
...
public class SpecView extends JETAPanel implements GridViewListener, FormSpecDefinition
{
   ...
   /**
    * Set to true if this flag indicates this view shows a RowSpec.  False if this view
    * is for a ColumnSpec;
    */
   ...
   /**
    * @return true if this spec view is for a row. False if this view is for a column.
    */
   ...
   /**
    * Updates the panel using the specs from the currently selected cell in the given editor
    */
