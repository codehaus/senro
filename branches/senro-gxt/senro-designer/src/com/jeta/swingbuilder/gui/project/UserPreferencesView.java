...
public class UserPreferencesView extends JETAPanel {
	...
	private void loadModel() {
		...
		setSelected(UserPreferencesNames.ID_CACHE_IMAGES, TSUserPropertiesUtils.getBoolean(
				UserPreferencesNames.ID_CACHE_IMAGES, true));
		setSelected(UserPreferencesNames.ID_OPEN_LAST_PROJECT, TSUserPropertiesUtils.getBoolean(
				UserPreferencesNames.ID_OPEN_LAST_PROJECT, true));
		setSelected(UserPreferencesNames.ID_STORE_AS_XML, TSUserPropertiesUtils.getBoolean(
				UserPreferencesNames.ID_STORE_AS_XML, false));

		setSelected(UserPreferencesNames.ID_SHOW_RESIZE_HANDLES, TSUserPropertiesUtils.getBoolean(
				UserPreferencesNames.ID_SHOW_RESIZE_HANDLES, true));

		javax.swing.JLabel label = new javax.swing.JLabel();
		String halign = TSUserPropertiesUtils.getString(LabelBeanFactory.ID_DEFAULT_HORIZONTAL_ALIGNMENT,
				LabelBeanFactory.getHorizontalAlignmentString(label.getHorizontalAlignment()));

		setSelectedItem(UserPreferencesNames.ID_LABEL_H_ALIGN, halign);
		setSelectedItem(UserPreferencesNames.ID_DEFAULT_RESIZE_UNITS, TSUserPropertiesUtils.getString(
				UserPreferencesNames.ID_DEFAULT_RESIZE_UNITS, "PX"));
	}
	...
	public void saveToModel() {
		...
		TSUserPropertiesUtils.setBoolean(UserPreferencesNames.ID_CACHE_IMAGES,
				isSelected(UserPreferencesNames.ID_CACHE_IMAGES));
		TSUserPropertiesUtils.setBoolean(UserPreferencesNames.ID_OPEN_LAST_PROJECT,
				isSelected(UserPreferencesNames.ID_OPEN_LAST_PROJECT));
		TSUserPropertiesUtils.setBoolean(UserPreferencesNames.ID_STORE_AS_XML,
				isSelected(UserPreferencesNames.ID_STORE_AS_XML));
		TSUserPropertiesUtils.setBoolean(UserPreferencesNames.ID_SHOW_RESIZE_HANDLES,
				isSelected(UserPreferencesNames.ID_SHOW_RESIZE_HANDLES));
		...
		TSUserPropertiesUtils.setString(UserPreferencesNames.ID_DEFAULT_RESIZE_UNITS,
				(String) getSelectedItem(UserPreferencesNames.ID_DEFAULT_RESIZE_UNITS));
