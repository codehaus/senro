...
public class DefaultLookAndFeelManager {
   ...
   private void createDefaultLookAndFeel(String lfLoader, String lfClassName, String lfThemeName, String name) {
      LookAndFeelInfo lf = new LookAndFeelInfo(lfLoader, lfClassName, lfThemeName, name, lfClassName + ","
               + lfThemeName);
   ...
   public LookAndFeelInfo getDefaultLookAndFeel() {
      ...
      if (JETAToolbox.isOSX()) {
         ...
         return findByClass("com.jgoodies.looks.plastic.PlasticXPLookAndFeel",
   ...
   private void loadDefaults() {
      try {
          ...
          * "com.incors.plaf.alloy.DefaultAlloyTheme", I18N.getLocalizedMessage(
          * "Alloy - Default" ) ); createDefaultLookAndFeel( ALLOY,
          * "com.incors.plaf.alloy.AlloyLookAndFeel",
         ...
         createDefaultLookAndFeel(JGOODIES, "com.jgoodies.looks.plastic.PlasticXPLookAndFeel",
                  "com.jgoodies.looks.plastic.theme.ExperienceBlue", I18N
                           .getLocalizedMessage("PlasticXP - Experience Blue"));

         createDefaultLookAndFeel(JGOODIES, "com.jgoodies.looks.plastic.PlasticXPLookAndFeel",
                  "com.jgoodies.looks.plastic.theme.ExperienceGreen", I18N
                           .getLocalizedMessage("PlasticXP - Experience Green"));

         createDefaultLookAndFeel(JGOODIES, "com.jgoodies.looks.plastic.PlasticXPLookAndFeel",
                  "com.jgoodies.looks.plastic.theme.SkyBlue", I18N.getLocalizedMessage("PlasticXP - Sky Blue"));
