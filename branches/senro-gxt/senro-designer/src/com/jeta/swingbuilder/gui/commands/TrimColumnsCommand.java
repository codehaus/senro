...
{
   /**
    * Factory used to create the default component for each cell in the new row.
    * @directed 
    */
   ...
   public void redo() throws CannotRedoException
   {
	 ...
	 for( int row=1; row <= view.getRowCount(); row++ )
	 {
	    ...
	    {
	       bempty = false;
	       //System.out.println( "TrimColumnsCommand  found non-empty column at 1:  bean delegate: " + bean_delegate );
	       break;
	    }
	 }
