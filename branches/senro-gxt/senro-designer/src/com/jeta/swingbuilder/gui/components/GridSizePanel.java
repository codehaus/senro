...
/**
 * This panel shows two text fields that allow a user to specify
 * the number of rows and columns for a new form view.
 * @author Jeff Tassin
 */
public class GridSizePanel extends JETAPanel implements JETARule
{
    ...
    * @param params an array one element: the GridSizePanel we are validating.
    *  It must be the same as the current this pointer.
    */
