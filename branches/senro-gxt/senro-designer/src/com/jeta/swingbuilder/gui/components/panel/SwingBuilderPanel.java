...
/**
 * An extension of FormPanel to provde some common features
 * needed in the swing builder app.
 * @author Jeff Tassin
 */
public class SwingBuilderPanel extends FormPanel
{
   ...
   /**
    * @return the ColorProperty for the JETAColorWell with the given name.
    * Null is returned if a JETAColorWell cannot be found.
    */
   ...
   /**
    * @return the ColorProperty for the ColorSelector with the given name.
    * Null is returned if a ColorSelector cannot be found.
    */
   ...
   /**
    * Sets the Color for the JETAColorWell with the given name.
    * The call is ignored if a JETAColorWell cannot be found.
    */
   ...
   /**
    * Sets the ColorProperty for the ColorSelector with the given name.
    * The call is ignored if a ColorSelector cannot be found.
    */
