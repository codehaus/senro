...
/**
 * The main purpose of this class is to display an icon in the
 * header cell that shows how the column is currently sorted.  There can be one of
 * three modes for this:
...
class SortedColumnHeaderRenderer extends JLabel implements TableCellRenderer
{
   ...
   /**
    * Gets the sort mode for this renderer.  Each column has a separate renderer.  When the
    * user sorts a given column, we put an icon in the header that shows whether the column is
    * ascending, descending, or natural ordering.  
    * @return mode the sort mode to set. We get the sort mode from the SortMode class:
   ...
   /**
    * Sets the sort mode for this renderer.  Each column has a separate renderer.  When the
    * user sorts a given column, we put an icon in the header that shows whether the column is
    * ascending, descending, or natural ordering.  
    * @param mode the sort mode to set. We get the sort mode from the SortMode class:
    *    ASCENDING, DESCENDING, or NONE
    */
