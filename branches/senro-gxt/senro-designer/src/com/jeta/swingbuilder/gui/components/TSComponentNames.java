...
{
   public static final String    NULL_TEXT;  // this is the text that appears in a component if it's value is set to null
   ...
   /**
    * This is a hack for the Windows Look and Feel.  When changing manually to the Windows L&F,
    * the toolbar separators somehow get changed to a --- horizontal orientation. This only happens
    * when the user changes the L&F and not at startup. So, we check if the user is changing the  L&F
    * and manually reset the toolbar separators.
    */
