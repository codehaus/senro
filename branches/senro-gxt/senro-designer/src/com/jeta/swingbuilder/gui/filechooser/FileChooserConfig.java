...
/**
 * This class is used to configure the file chooser dialog. Parameters
 * such as initial directory, file filters, etc are set in this config class.
 * @author Jeff Tassin
 */
public class FileChooserConfig
{
   ...
   /**
    * This is used when loading files of a given type. It is not the file filter. Rather
    * is is used to store the directory last accessed for this type. For example,
    * if the type is an ".img", we want to store the directory last accessed for images.
    * However, if the file is a ".txt", we don't want to go to the last images directory
    * but rather the last .txt directory.
    */
