...
public class ComponentsToolBar extends JETAPanel implements ComponentSource
{
    ...
    private Collection registerDefaultBeans()
    {
        try {
            ...
            btns.add(registerBean(ID_SELECTION_TOOL, I18N.getLocalizedMessage("Selection Tool"),
                                  null,
                                  Icons.MOUSE_16));
...
//
//		  btns.add( registerBean( ID_GENERIC_COMPONENT,  I18N.getLocalizedMessage("Generic Component"),
//			      new GenericComponentFactory( this ), Icons.GENERIC_COMPONENT_16 ) );
//
//		  add_forms = false;
//	       }

	       Class bean_class = bm.getBeanClass( bname );
	       btns.add( registerBean( bname, rbean.getDescription(),
				       new SwingComponentFactory( this, bname ),
				       icon ) );
	    }
	    catch( Exception e )
	    {
    ...
    /**
     * ComponentSource implementation
