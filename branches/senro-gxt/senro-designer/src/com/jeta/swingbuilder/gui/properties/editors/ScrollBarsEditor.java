...
/**
 * Property editor for scrollbars.  A scroll property is a custom
 * JETAProperty for scrollable components such as JTextArea, JList, JTable, etc.
 * We currently don't support directly editing JScrollPanes in the builder
 * so we have this 'psuedo' property instead that is attached to scrollable components.
 * 
 * @author Jeff Tassin
 */
