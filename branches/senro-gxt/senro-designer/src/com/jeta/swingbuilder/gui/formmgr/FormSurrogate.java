...
/**
 * This class acts as a place-holder for a FormComponent.  This
 * is needed because we can have multiple views opened for
 * the same FormComponent.  For example, in one view, a FormComponent
 * could be part of a nest.  In another view, this component could
 * be in a top level view.
 * @author Jeff Tassin
 */
