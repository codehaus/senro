...
public class FormObjectFlavor
{
   ...
   public static boolean isDesignerFlavorSupported( Transferable t )
   {
      try
      {
	 return ( t.isDataFlavorSupported( COMPONENT_MEMENTO ) ||
		  t.isDataFlavorSupported( LINKED_FORM_SET ) ||
		  t.isDataFlavorSupported( LINKED_FORM ) ||
		  t.isDataFlavorSupported( CELL_BACKGROUND ) );
      }
      catch( Exception e )
      {
	 e.printStackTrace();
