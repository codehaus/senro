...
public abstract class AbstractBorderView extends SwingBuilderPanel
{
   ...
   public FormPanel getView() { return this; }
   ...
   /**
    * @return a description for this view.  Typically used for a title in a dialog
    */
   public abstract String getDescription();

   /**
    * Adds a custom 'default' color to the colorselectivew with the given name.  This
    * is needed because the BevelBorder can defines its colors based on the component associated
    * with the border.
    */
   ...
   public void setBorderProperty( BorderProperty border )
   {
	 ...
	 cbox.setSelected( border.isIncludeTitle() );
      ...
      getComboBox( BorderNames.ID_TITLE_JUSTIFICATION_COMBO ).setSelectedItem( new ListItemProperty( BorderProperty.toJustificationString( border.getJustification() ) ) );
