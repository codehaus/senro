...
public class FocusView extends JETAPanel implements GridViewListener
{
   ...
   /**
    * This method makes sure an ArrayList has at least
    * sz elements.  This guarantees that a call to list.size()
    * will be valid for sz elements.
   ...
   public class FocusBoxListener implements ActionListener
   {
	 ...
	 else if ( FocusBox.FOCUS_INDEX_CHANGED.equals( evt.getActionCommand() ) )
	 {
      ...
      boolean isSilent() { return m_silent; }
      void setSilent( boolean silent ) { m_silent = silent; }
   }
