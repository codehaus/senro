...
/**
 * This class is responsible for handling the docking behavior of the properties window.
 *
 * @author Jeff Tassin
 */
public class FrameDocker
{
    ...
    * ctor
    */
   public FrameDocker( JPanel main_panel, JPanel editor_panel, JSplitPane split, FormPanel properties_view )
   {
    ...
    */
   public void dockPropertiesFrame( Rectangle bounds )
   {
