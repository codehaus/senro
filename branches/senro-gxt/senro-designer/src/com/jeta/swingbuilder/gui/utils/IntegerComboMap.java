...
/**
 * Very often we have JComboBoxes that are loaded with String values
 * but which map to integers.  So, we use this helper class to make 
 * using combo boxes in these situations a little easier.
 * @author Jeff Tassin
 */
public class IntegerComboMap
{
   ...
   /**
    * @return the selected map value.
    * -1 is returned if no item is selected in the box or no match is found in
    * this map for the selected item in the combo.
    */
