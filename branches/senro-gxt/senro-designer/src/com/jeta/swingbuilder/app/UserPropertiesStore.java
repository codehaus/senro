...
{
   private static final String    PROPS_RESOURCE_NAME = "userdata.properties"; // the name of the 'file' we store to
   ...
   /**
    * Reads the named property for the given keyname from the user properties store.
    * This method does not throw any exceptions, it is assumed the implementor will
    * log the exception somewhere
    * @param keyName the unique key name to get the property for
   ...
   /**
    * Reads the named property for the given key from the user properties store.
    * This method does not throw any exceptions, it is assumed the implementor will
    * log the exception somewhere
    * @param keyName the unique key name within that component to get the property for
