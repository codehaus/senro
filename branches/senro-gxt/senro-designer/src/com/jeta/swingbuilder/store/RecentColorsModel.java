...
public class RecentColorsModel implements Externalizable
{
   ...
   /**
    * Returns the ColorHolder at the given index.  If the index is invalid
    * null is returned.
    */
   ...
   /**
    * Returns the ColorHolder at the given index.  If the index is invalid
    * the defaultColor is returned. 
    * @param index the index 
    * @param defaultColor the color to return if the index is outside the valid range
    * or if a null is found at the given index.
    */
