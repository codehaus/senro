...
public class DefaultProjectManager implements ProjectManager {
   ...
   public boolean isValidResource(String relpath) {
      // System.out.println( "DefaultProjectmanager.isValidResource: " + relpath
      // );
      if (relpath == null)
         return false;
    ...
    * 
    * @param imageName
    *           the subdirectory and name of image file (i.e. images/edit16.gif )
    */
   public ImageIcon loadImage(String imageName) {
      ...
      if (isJETAResource(imageName)) {
         ...
         try {
            ...
            if (path != null) {
               /**
                * The toolkit should be used to create the image, otherwise it
                * may be pulled from the toolkit image cache.
                */
   ...
   public void setProject(ProjectModel pmodel) {
      ...
      if (pmodel != null) {
         ...
         while (iter.hasNext()) {
            ...
            File f = new File(project_parent + File.separatorChar + src_path);
            try {
               if (f.isDirectory()) {
