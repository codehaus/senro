...
public class JavaTokenContext extends TokenContext {
    ...
    static {
        BaseImageTokenID[] kwds = new BaseImageTokenID[] {
            ABSTRACT, BREAK, CASE, CATCH, CLASS, CONST, CONTINUE, DEFAULT, DO, 
            ELSE, EXTENDS, FALSE, FINAL, FINALLY, FOR, GOTO, IF, IMPLEMENTS, 
            IMPORT, INSTANCEOF, INTERFACE, NATIVE, NEW, NULL, PACKAGE, PRIVATE, 
            PROTECTED, PUBLIC, RETURN, STATIC, SUPER, SWITCH, SYNCHRONIZED, THIS, 
