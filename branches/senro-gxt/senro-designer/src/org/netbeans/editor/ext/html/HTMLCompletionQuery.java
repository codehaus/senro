...
//                l = translateTags( offset-len, len, sup.getPossibleStartTags ( offset-len, preText.substring( 1 )  ) );
            /* EndTag finder */
            } else if( id == HTMLTokenContext.TEXT && preText.endsWith( "</" ) ) {
                len = 2;
...
//System.err.println("l = " + l );
            ...
            else return new CompletionQuery.DefaultResult( component, "Results for DOCTYPE " + dtd.getIdentifier(), l, offset, len );
