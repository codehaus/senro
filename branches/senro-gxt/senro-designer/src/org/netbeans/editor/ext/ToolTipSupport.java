...
SettingsChangeListener, FocusListener {
    ...
    /** Update bounds of the tooltip component. It gets
     * called when the tooltip component is about to be shown
     * or when it was updated by {@link #setToolTip(javax.swing.JComponent)}.
     */
    protected void updateToolTipBounds() {
        ...
        int x = Math.min(lastMouseEvent.getX() - prefSize.width / 2,
