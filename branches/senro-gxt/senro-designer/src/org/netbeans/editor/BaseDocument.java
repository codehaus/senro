...
/*                    throw new IllegalArgumentException("Line index=" + index // NOI18N
                            + " is invalid. Maximum index is " // NOI18N
                            + (Utilities.getRowCount(BaseDocument.this) - 1)
                            + " in the document " // NOI18N
                            + Utilities.debugDocument(BaseDocument.this) + "." // NOI18N
                    );
*/
                    return getElement(Utilities.getRowCount(BaseDocument.this) - 1); // last line
