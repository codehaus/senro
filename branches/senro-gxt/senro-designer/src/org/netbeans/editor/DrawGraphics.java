...
interface DrawGraphics {
    ...
    * @param strikeThroughColor color to be used for strike-through or null
    *   if the strike-through shouldn't be done.
    * @param underlineColor color to be used for underlining or null
    *   if the underlining shouldn't be done.
    */
    public void drawChars(int offset, int length, int width,
                          Color strikeThroughColor, Color underlineColor);
    ...
    */
    static final class GraphicsDG extends SimpleDG {
        ...
        */
        ...
        private void flush() {
            ...
            if (strikeThroughColor != null) { // draw strike-through
                ...
                graphics.fillRect(startX,
                                  startY + (int)(fmcInfo.getStrikethroughOffset(graphics) + 0.5),
                                  x - startX,
            ...
            if (underlineColor != null) { // draw underline
                ...
                graphics.fillRect(startX,
                                  startY + (int)(fmcInfo.getUnderlineOffset(graphics) + 1.5),
                                  x - startX,
        ...
        public void drawChars(int offset, int length, int width,
                              Color strikeThroughColor, Color underlineColor) {
            // Check if strike-through and underline colors match the current ones
