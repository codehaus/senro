...
public class SenroContextInspector extends CommonInspector
{
    public static final String SC_INSPECTOR_TITLE = "Senro Context Inspector";
    public static final String ADD_ACTION = "Add";
    public static final String DELETE_ACTION = "Delete";
    protected SenroContextDescription senroContextDescription = null;
    ...
    {
        senroContextDescription = (SenroContextDescription) o;
        super.setObject(o);
    }

    public void updateUI()
    {
        if (senroContextDescription == null) {
            return;
        }
        super.updateUI();
    ...
    {
        senroContextDescription.addContextParameter();
        contextParametersTable.tableChanged(new TableModelEvent(model));
    }
    ...
    private void deleteContextParameter()
    {
        ...
        senroContextDescription.removeContextParameter(sel_row);
        contextParametersTable.tableChanged(new TableModelEvent(model));
    }
    ...
    public class ContextParametersModel extends AbstractTableModel
    {
        ...
        public int getRowCount()
        {
            ...
            return senroContextDescription.getContextParametersCount();
        }
        ...
        {
            if (senroContextDescription == null || getRowCount() == 0) {
                return null;
            }
            Object value = "";
            SenroContextDescription.ParamEntry p_entry = senroContextDescription.getParametersEntry(rowIndex);
            switch (columnIndex) {
                case NAME_IDX:
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex)
        {
            ...
            switch (columnIndex) {
                case NAME_IDX:
                    ...
                    if (senroContextDescription.isValidNewParamEntryName((String) aValue)) {
