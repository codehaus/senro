...
public abstract class BranchesMgrBase extends ro.siveco.svapnt.common.session.OrgUnitMgrImpl
{
	public static <T> T getInstance() throws LookUpException
	{
		return (T) getInstance(ro.siveco.svapnt.common.session.BranchesMgrLocal.JNDI_NAME);
	}
