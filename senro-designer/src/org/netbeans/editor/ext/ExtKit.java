...
//            new CodeSelectAction(),   // the actionPerformed is empty and so I'm removing the action from the list
            ...
            new ExtUpAction(upAction, false),
            new ExtPageUpAction(pageUpAction, false),
            new ExtDownAction(downAction, false),
            new ExtPageDownAction(pageDownAction, false),
            new ExtBeginLineAction(beginLineAction, false),
            new ExtBeginLineAction(selectionBeginLineAction, true),            
            new ExtEndLineAction(endLineAction, false),
            new ExtEndLineAction(selectionEndLineAction, true),            
