...
public class JavaCompletionQuery implements CompletionQuery {
    ...
    * @param sourceHelp whether the help is retrieved to open the source file.
    *  The query behavior is slightly modified if this flag is true
    * @return result of the query or null if there's no result.
    */
    public CompletionQuery.Result query(JTextComponent component, int offset,
                                        SyntaxSupport support, boolean sourceHelp) {
            ...
            if (lastValidTokenID != null) {
                ...
                case JavaTokenContext.BLOCK_COMMENT_ID:
                    if (tp.getLastValidTokenText() == null
                            || !tp.getLastValidTokenText().endsWith("*/")
                    ) {
                        inComment = true;
                    }
                    break;
    ...
    */
    ...
    static class Context {
        ...
        */
        ...
        public Context(JCTokenProcessor tp, JTextComponent component,
                       JavaSyntaxSupport sup, boolean sourceHelp, int endOffset) {
            this.tp = tp;
