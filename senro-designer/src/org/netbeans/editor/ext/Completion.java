        ...
        if (component != null && doc != null) 
	{
            ...
            try
	    {
		  ...
		  caretPos = doc.getLength();
	       ...
	       //System.out.println( "caretPos = " + caretPos + "  component.getCaret().getDot() =  " + component.getCaret().getDot() );
	       //System.out.println( " Utilities.getRowStart1 = " + Utilities.getRowStart(component,component.getCaret().getDot() ) );
	       //if ( caretPos != -1 )
	       // System.out.println( " Utilities.getRowStart2 = " + Utilities.getRowStart(component,caretPos ) );

	       if( (caretPos!=-1) 
		    && (Utilities.getRowStart(component,component.getCaret().getDot()) != Utilities.getRowStart(component,caretPos)) )
		{
