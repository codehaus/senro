...
import com.jeta.swingbuilder.gui.main.*;
...
public class IBMainFrame extends JFrame implements ComponentSource, GridViewListener, ActionListener, JETAContainer,
        EditorManager
{
     ...
     */
    private IBMainFrameController m_controller;
     ...
     */
    private IBMainFormManager m_formmgr;

    /**
     * Handles enabling/disabling
     */
    private IBMainFrameUIDirector m_uidirector;
    ...
    public IBMainFrame()
    {
        super("SENRO Interface Designer");
        ...
        try {
            ...
            m_formmgr = new IBMainFormManager(this);
            ...
            m_uidirector = new IBMainFrameUIDirector(this);
            m_controller = new IBMainFrameController(this);
    ...
    private JMenu createLookAndFeelMenu()
    {
        ...
        DefaultLookAndFeelManager lfm = (DefaultLookAndFeelManager) JETARegistry
                .lookup(DefaultLookAndFeelManager.COMPONENT_ID);
...
//        menu.add(i18n_createMenuItem("Save As", MainFrameNames.ID_SAVE_FORM_AS, null));
        ...
        menu.add(i18n_createMenuItem("Cut", TSComponentNames.ID_CUT, KeyStroke.getKeyStroke(KeyEvent.VK_X,
                InputEvent.CTRL_MASK, false)));
        menu.add(i18n_createMenuItem("Copy", TSComponentNames.ID_COPY, KeyStroke.getKeyStroke(KeyEvent.VK_C,
                InputEvent.CTRL_MASK, false)));
        menu.add(i18n_createMenuItem("Paste", TSComponentNames.ID_PASTE, KeyStroke.getKeyStroke(KeyEvent.VK_V,
                InputEvent.CTRL_MASK, false)));
        menu.addSeparator();
        menu.add(i18n_createMenuItem("Undo", TSComponentNames.ID_UNDO, KeyStroke.getKeyStroke(KeyEvent.VK_Z,
                InputEvent.CTRL_MASK, false)));
        menu.add(i18n_createMenuItem("Redo", TSComponentNames.ID_REDO, KeyStroke.getKeyStroke(KeyEvent.VK_Y,
                InputEvent.CTRL_MASK, false)));
        menuBar.add(menu);

        JMenu submenu = new JMenu(I18N.getLocalizedMessage("Column"));
        submenu.add(i18n_createMenuItem("Insert Left", FormEditorNames.ID_INSERT_COLUMN_LEFT, KeyStroke.getKeyStroke(
                KeyEvent.VK_L, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Insert Right", FormEditorNames.ID_INSERT_COLUMN_RIGHT, KeyStroke.getKeyStroke(
                KeyEvent.VK_R, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Set As Separator", FormEditorNames.ID_SET_AS_COLUMN_SEPARATOR, KeyStroke
                .getKeyStroke(KeyEvent.VK_P, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Set As Large Separator", FormEditorNames.ID_SET_AS_BIG_COLUMN_SEPARATOR, null));

        submenu.add(i18n_createMenuItem("Delete Column", FormEditorNames.ID_DELETE_COLUMN, KeyStroke.getKeyStroke(
                KeyEvent.VK_D, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Trim", FormEditorNames.ID_TRIM_COLUMNS, null));

        submenu.addSeparator();

        submenu.add(i18n_createMenuItem("Size: Preferred", FormEditorNames.ID_COLUMN_PREFERRED_SIZE, KeyStroke
                .getKeyStroke(KeyEvent.VK_W, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Resize: Grow", FormEditorNames.ID_COLUMN_RESIZE_GROW, KeyStroke.getKeyStroke(
                KeyEvent.VK_G, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Resize: None", FormEditorNames.ID_COLUMN_RESIZE_NONE, KeyStroke.getKeyStroke(
                KeyEvent.VK_G, InputEvent.SHIFT_MASK, false)));

        submenu.addSeparator();
        submenu.add(i18n_createMenuItem("Increase Column Span", FormEditorNames.ID_COLUMN_INCREASE_SPAN, KeyStroke
                .getKeyStroke(KeyEvent.VK_RIGHT, InputEvent.SHIFT_MASK, false)));
        submenu.add(i18n_createMenuItem("Decrease Column Span", FormEditorNames.ID_COLUMN_DECREASE_SPAN, KeyStroke
                .getKeyStroke(KeyEvent.VK_LEFT, InputEvent.SHIFT_MASK, false)));

        menuBar.add(submenu);

        submenu = new JMenu(I18N.getLocalizedMessage("Row"));
        submenu.add(i18n_createMenuItem("Insert Above", FormEditorNames.ID_INSERT_ROW_ABOVE, KeyStroke.getKeyStroke(
                KeyEvent.VK_A, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Insert Below", FormEditorNames.ID_INSERT_ROW_BELOW, KeyStroke.getKeyStroke(
                KeyEvent.VK_B, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Set As Separator", FormEditorNames.ID_SET_AS_ROW_SEPARATOR, KeyStroke
                .getKeyStroke(KeyEvent.VK_E, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Set As Large Separator", FormEditorNames.ID_SET_AS_BIG_ROW_SEPARATOR, null));

        submenu.add(i18n_createMenuItem("Delete Row", FormEditorNames.ID_DELETE_ROW, KeyStroke.getKeyStroke(
                KeyEvent.VK_K, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Trim", FormEditorNames.ID_TRIM_ROWS, null));

        submenu.addSeparator();
        submenu.add(i18n_createMenuItem("Size: Preferred", FormEditorNames.ID_ROW_PREFERRED_SIZE, KeyStroke.getKeyStroke(
                KeyEvent.VK_H, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Resize: Grow", FormEditorNames.ID_ROW_RESIZE_GROW, KeyStroke.getKeyStroke(
                KeyEvent.VK_U, InputEvent.CTRL_MASK, false)));
        submenu.add(i18n_createMenuItem("Resize: None", FormEditorNames.ID_ROW_RESIZE_NONE, KeyStroke.getKeyStroke(
                KeyEvent.VK_U, InputEvent.SHIFT_MASK, false)));
        submenu.addSeparator();
        submenu.add(i18n_createMenuItem("Increase Row Span", FormEditorNames.ID_ROW_INCREASE_SPAN, KeyStroke
                .getKeyStroke(KeyEvent.VK_DOWN, InputEvent.SHIFT_MASK, false)));
        submenu.add(i18n_createMenuItem("Decrease Row Span", FormEditorNames.ID_ROW_DECREASE_SPAN, KeyStroke
                .getKeyStroke(KeyEvent.VK_UP, InputEvent.SHIFT_MASK, false)));

        menuBar.add(submenu);

        menu = new JMenu(I18N.getLocalizedMessage("Form"));
        menu.add(i18n_createMenuItem("Show Form", MainFrameNames.ID_SHOW_FORM, KeyStroke.getKeyStroke(KeyEvent.VK_F,
                InputEvent.CTRL_MASK, false)));
        menu.add(i18n_createMenuItem("Toggle Grid", FormEditorNames.ID_SHOW_GRID, KeyStroke.getKeyStroke(KeyEvent.VK_G,
                InputEvent.CTRL_MASK, false)));
    ...
    private void createStatusBar()
    {
        ...
        m_status_cell.setBorder(BorderFactory.createCompoundBorder(m_status_cell.getBorder(), BorderFactory
    ...
    private void createToolBar()
    {
        ...
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_INSERT_COLUMN_LEFT, Icons.COLUMN_INSERT_24,
                "Insert Column"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_DELETE_COLUMN, Icons.COLUMN_DELETE_24, "Delete Column"));

        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_SET_AS_COLUMN_SEPARATOR, Icons.COLUMN_SEP_SMALL_24,
                "Set As Column Separator"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_SET_AS_BIG_COLUMN_SEPARATOR, Icons.COLUMN_SEP_LARGE_24,
                "Set As Large Column Separator"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_COLUMN_RESIZE_GROW, Icons.COLUMN_GROW_24,
                "Column Resize: Grow"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_COLUMN_RESIZE_NONE, Icons.COLUMN_NOGROW_24,
                "Column Resize: None"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_COLUMN_INCREASE_SPAN, Icons.COLUMN_INCREASE_SPAN_24,
                "Increase Column Span"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_COLUMN_DECREASE_SPAN, Icons.COLUMN_DECREASE_SPAN_24,
        ...
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_SET_AS_ROW_SEPARATOR, Icons.ROW_SEP_SMALL_24,
                "Set As Row Separator"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_SET_AS_BIG_ROW_SEPARATOR, Icons.ROW_SEP_LARGE_24,
                "Set As Large Row Separator"));

        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_ROW_RESIZE_GROW, Icons.ROW_GROW_24, "Row Resize: Grow"));
        toolbar
                .add(i18n_createToolBarButton(FormEditorNames.ID_ROW_RESIZE_NONE, Icons.ROW_NOGROW_24,
                        "Row Resize: None"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_ROW_INCREASE_SPAN, Icons.ROW_INCREASE_SPAN_24,
                "Increase Row Span"));
        toolbar.add(i18n_createToolBarButton(FormEditorNames.ID_ROW_DECREASE_SPAN, Icons.ROW_DECREASE_SPAN_24,
                "Decrease Row Span"));

        /*
        * Need a better help icon toolbar.addSeparator(); javax.swing.JButton btn =
        * i18n_createToolBarButton( MainFrameNames.ID_HELP, "general/Help24.gif",
        * "Help" ); com.jeta.swingbuilder.help.HelpUtils.enableHelpOnButton( btn,
    ...
    /**
     * Called when the form component's path has changed. We update the tab label
     * in this case.
     */
    ...
    /**
     * @return the buttonbar that contains the property pane, FormSpec views, and
     *         CellConstaint view
     */
    ...
    /**
     * @return the editor that is currently active in the frame. Null is returned
     *         if no editors are opened.
     */
    ...
    /**
     * @return the editor whose main form is the given form. If the given form is
     *         not opened in its own editor, null is returned.
     */
    ...
    private void initializeFrameBounds()
    {
        try {
            ...
            Rectangle rect = (Rectangle) os.load(IBMainFrame.ID_FRAME_BOUNDS);
            if (rect != null) {
    ...
    void shutDown()
    {
        try {
            ObjectStore os = (ObjectStore) JETARegistry.lookup(ComponentNames.APPLICATION_STATE_STORE);
            os.store(IBMainFrame.ID_FRAME_BOUNDS, getBounds());
        ...
        if (m_controller.closeProject() == IBMainFrameController.CLOSE_OK) {
            dispose(); // close all open frame windows. this allows them to save
            // their state
