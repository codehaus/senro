...
public class TemplateRendererBeanFactory implements BeanFactory
{
    ...
    public JETABean createBean(String compName, boolean instantiateBean, boolean setDefaults) throws FormException
    {
        Component comp = null;
        if(instantiateBean) {
            comp = new TemplateRendererComponent();
            comp.setName(compName);
        }

        DynamicBeanInfo beaninfo = JComponentBeanFactory.createBeanInfo(TemplateRendererComponent.class);
