...
import com.jeta.swingbuilder.gui.commands.*;
...
import com.jeta.swingbuilder.gui.main.FormEditorNames;
import com.jeta.swingbuilder.gui.main.PasteSpecialNames;
import com.jeta.swingbuilder.gui.main.PasteSpecialView;
 ...
 */
public abstract class IBFormEditorController extends JETAController
{
    ...
    public IBFormEditorController(IBMainFrame frame, JPopupMenu popup)
    {
        super(frame);
        mainFrame = frame;
        m_popup = popup;
     ...
     */
    public void installHandlers(FormEditor editor)
    {
    ...
    /**
     * Creates a paste command. Gets a grid component memento from the clipboard,
     * instantiates a new component, sets the state and places it on the parent
     * view
     */
    private FormUndoableEdit getPasteCommand(GridView parentView, Transferable transferable)
    {
        try {
            ...
            if (oldcomp != null) {
                ComponentMementoProxy cmproxy = (ComponentMementoProxy) transferable
                        .getTransferData(FormObjectFlavor.COMPONENT_MEMENTO);
                ...
                if (FormComponent.class.isAssignableFrom(compclass)) {
                    FormComponentFactory factory = (FormComponentFactory) JETARegistry
                            .lookup(FormComponentFactory.COMPONENT_ID);
    ...
    public class ColumnSetPreferredSizeAction extends AbstractAction
    {
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                ColumnSpec newspec = new ColumnSpec(oldspec.getDefaultAlignment(), Sizes.PREFERRED, oldspec
                        .getResizeWeight());
    ...
    public class CutAction implements ActionListener
    {
        public void actionPerformed(ActionEvent evt)
        {
            GridComponent gc = getCurrentEditor().getSelectedComponent();
            if (gc != null) {
                IBFormEditorController.this.invokeAction(TSComponentNames.ID_COPY);
                IBFormEditorController.this.invokeAction(FormEditorNames.ID_DELETE_COMPONENT);
            }
        }
    }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null && view.getColumnCount() > 1) {
                    ...
                    DeleteColumnCommand cmd = new DeleteColumnCommand(view.getParentForm(), col, getCurrentEditor()
                            .getComponentSource());
                    CommandUtils.invoke(cmd, getCurrentEditor());
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null && view.getRowCount() > 1) {
                    int row = gc.getRow();
                    int col = gc.getColumn();
                    DeleteRowCommand cmd = new DeleteRowCommand(view.getParentForm(), row, getCurrentEditor()
                            .getComponentSource());
                    CommandUtils.invoke(cmd, getCurrentEditor());
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null) {
                    ...
                    ColumnSpec oldspec = view.getFormLayout().getColumnSpec(col);
                    String newspec = javax.swing.JOptionPane.showInputDialog(mainFrame, I18N
                            .getLocalizedMessage("Column Spec:"), oldspec.toString());
                    if (newspec != null) {
                        EditColumnSpecCommand cmd = new EditColumnSpecCommand(view.getParentForm(), col, new ColumnSpec(
                                newspec), oldspec);
                        CommandUtils.invoke(cmd, getCurrentEditor());
                    }
                }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (comp != null) {
                    ...
                    String newvalue = javax.swing.JOptionPane.showInputDialog(mainFrame, I18N.getLocalizedMessage("Set Name"),
                            oldname);
                    if (newvalue != null) {
                        comp.setName(newvalue);
                        gc.fireGridCellEvent(new GridCellEvent(GridCellEvent.EDIT_COMPONENT, gc,
                                GridCellEvent.COMPONENT_NAME_CHANGED));
                    }
                }
            }
        }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null) {
                    ...
                    String newspec = javax.swing.JOptionPane.showInputDialog(mainFrame, I18N.getLocalizedMessage("Row Spec:"),
                            oldspec.toString());
                    if (newspec != null) {
                        EditRowSpecCommand cmd = new EditRowSpecCommand(view.getParentForm(), row, new RowSpec(newspec),
                                oldspec);
                        CommandUtils.invoke(cmd, getCurrentEditor());
                    }
                }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null) {
                    ...
                    InsertColumnCommand cmd = new InsertColumnCommand(view.getParentForm(), col, new ColumnSpec(colspec),
                            new EmptyComponentFactory(getCurrentEditor().getComponentSource()));
                    CommandUtils.invoke(cmd, getCurrentEditor());
                }
            }
        }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null) {
                    ...
                    String rowspec = "d";
                    InsertRowCommand cmd = new InsertRowCommand(view.getParentForm(), row, new RowSpec(rowspec),
                            new EmptyComponentFactory(getCurrentEditor().getComponentSource()));
                    CommandUtils.invoke(cmd, getCurrentEditor());
                }
            }
                ...
                if (oldcomp != null) {
                    ...
                    if (transferable.isDataFlavorSupported(FormObjectFlavor.LINKED_FORM_SET)) {
                        ...
                        if (transferable.isDataFlavorSupported(FormObjectFlavor.COMPONENT_MEMENTO)) {
                            // means we have a top level embedded form with nested
                            // links
                    ...
                    if (transferable.isDataFlavorSupported(FormObjectFlavor.CELL_BACKGROUND)) {
                        ...
                        SetCellBackgroundCommand cmd = new SetCellBackgroundCommand(view.getParentForm(), col, row, paint,
                                oldpaint);
                        CommandUtils.invoke(cmd, getCurrentEditor());
                    }
                }
            ...
            try {
                ...
                if (oldcomp != null) {
                    ...
                    if (dlg.isOk()) {
                        ...
                        if (transferable.isDataFlavorSupported(FormObjectFlavor.LINKED_FORM_SET)
                                && view.isSelected(PasteSpecialNames.ID_LINKED_AS_EMBEDDED)) {
                        ...
                        if (transferable.isDataFlavorSupported(FormObjectFlavor.COMPONENT_MEMENTO)
                                && view.isSelected(PasteSpecialNames.ID_COMPONENT)) {
                            cmd = getPasteCommand(gridview, transferable);
                        }

                        FormUndoableEdit pp_cmd = null;
                        if (transferable.isDataFlavorSupported(FormObjectFlavor.CELL_BACKGROUND)
                                && view.isSelected(PasteSpecialNames.ID_CELL_BACKGROUND)) {
                            PaintProperty paint = (PaintProperty) transferable
                                    .getTransferData(FormObjectFlavor.CELL_BACKGROUND);
        ...
        public void actionPerformed(ActionEvent evt)
        {
            try {
                ...
                if (oldcomp != null) {
                    ...
                    if (transferable.isDataFlavorSupported(FormObjectFlavor.LINKED_FORM)) {
                        /**
                         * if LINKED_FORM is supported, then GRID_COMPONENT must also
                         * be supported
                         */
                        if (transferable.isDataFlavorSupported(FormObjectFlavor.COMPONENT_MEMENTO)) {
                            pasteComponent(view, transferable);
    ...
    public class SetColumnSeparatorAction extends AbstractAction
    {
        ...
        {
            String units_prop_name = m_std_size ? UserPreferencesNames.ID_COL_STD_SEP_UNITS
                    : UserPreferencesNames.ID_COL_LARGE_SEP_UNITS;
            String sz_prop_name = m_std_size ? UserPreferencesNames.ID_COL_STD_SEP_SIZE
                    : UserPreferencesNames.ID_COL_LARGE_SEP_SIZE;
    ...
    public class SetRowSeparatorAction extends AbstractAction
    {
        ...
        private String getSeparatorSpec()
        {
            String units_prop_name = m_std_size ? UserPreferencesNames.ID_ROW_STD_SEP_UNITS
                    : UserPreferencesNames.ID_ROW_LARGE_SEP_UNITS;
            String sz_prop_name = m_std_size ? UserPreferencesNames.ID_ROW_STD_SEP_SIZE
                    : UserPreferencesNames.ID_ROW_LARGE_SEP_SIZE;
    ...
    public class TrimColumnsAction extends AbstractAction
    {
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (gc != null) {
                ...
                if (view != null && view.getColumnCount() > 1) {
                    FormManager fmgr = (FormManager) JETARegistry.lookup(FormManager.COMPONENT_ID);
                    TrimColumnsCommand cmd = new TrimColumnsCommand(view.getParentForm(), getCurrentEditor()
                            .getComponentSource());
                    CommandUtils.invoke(cmd, getCurrentEditor());
                    FormManagerDesignUtils.clearUnreferencedForms();
                }
    ...
    public class UndoAction extends AbstractAction
    {
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (cmd instanceof SetPropertyCommand) {
                java.awt.Component controls_view = mainFrame.getCurrentControlsView();
