...
public class HelpUtils
{
   ...
   public static void enableHelpOnButton( javax.swing.AbstractButton btn, String id )
   {
	 ...
	 /** 
	  * from CSH source    
	  * @see CSH.setHelpIDString( btn, id ); 
	  * We don't call CSH here because we don't want to load the classes until the
	  * user actually presses the help button */
    ...
    * the helpset unless the user explicitly presses the help button.  It is hoped that
    * this would improve startup performance because it is one less thing that has to be loaded; however
    * no tests were run to prove that this actually helps.
    */
