...
public interface TSUserProperties
{
   ...
   /**
    * Reads the named property for the given component from the user properties store.
   ...
   /**
    * Reads the named property for the given key name from the user properties store.
    * This method does not throw any exceptions, it is assumed the implementor will
    * log the exception somewhere
   ...
   /**
    * Stores the named property for the given key.
    * This method does not throw any exceptions, it is assumed the implementor will
    * log the exception somewhere
    */
