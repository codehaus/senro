...
public interface ResourceLoader
{
   ...
   /**
    * Creates a resource(file) relative to the application directory
    * e.g.   createResource( "keybindings/emacs.xml" ); will create the file emacs.xml in
    *        the keybindings directory off of the main subdirectory
    * @param resourceName a path and file name of the file to create.  
    */
   ...
   /**
    * Creates a set of subdirectories under the main resources directory.
    * e.g. createDirectories( "data/application" );  This will create the
    * directory structure:  TS_HOME/resources/data/application
    */
   ...
   /**
    * Lists all files that are found in the given subdirectory. The subdirectory is relative
    * to the main application directory.
    * @param subdirectory the subdirectory whose file names we are going to return.  Only
    *      the name of the file is returned (no path information)
    * @param regexFilter this is a regular expression filter that you can use to locate the files
    */
   public String[] listFiles( String subdirectory, String regexFilter ) throws IOException;

   /**
    * Utility method that loads an image.
    * @param imageName the subdirectory and name of image file (i.e. images/edit16.png )
    */
