...
/**
 * A component finder used for design time. In this case we don't
 * want component listeners added to anything owned by the FormEditor.
 * The reason is because the XMLEncoder/XMLDecoder will store
 * the container listeners added by the design components that are
 * not needed when in runtime.
 *
 * @author Jeff Tassin
 */
