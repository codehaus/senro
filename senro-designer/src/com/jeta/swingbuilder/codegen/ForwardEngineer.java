...
{
   /**
    * This is a map of form ids to the last filename used to store generated code
    * for that form.  It is used to popuplate the file save dialog so the user does
    * not have to re-type the file name every time.
    */
	 ...
	 dlg.addDialogListener( new JETADialogListener() 
	    {
		  ...
		  else
		  {
			...
			return true;
		     ...
		     {
			TSErrorDialog2 dlg = TSErrorDialog2.createDialog( parent, "Error", "Unable to save file", e );
			dlg.showCenter();
			return false;
		     }
		  }
