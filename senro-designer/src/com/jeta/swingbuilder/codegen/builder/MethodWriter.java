...
public class MethodWriter implements DeclarationManager
{
   ...
   /**
    * The BeanWriter associated with this return value of this method declaration
    */
   ...
   /**
    * A list of Strings that make up the method comments. Each String object
   ...
   /**
    * Adds a line to the comments for this method.  Do NOT include any /*, * tokens because
   ...
   /**
    * This returns the name of a method used for loading resources in 
    * a form such as Icons and strings.
    */
