...
public class BuilderUtils
{
   ...
   public static void buildInitializer( DeclarationManager declMgr, String methodExpression )
   {
      ...
      Block block = new Block();
      String frame_code = "setLayout(new BorderLayout());" +
	 "add(" + methodExpression + ", BorderLayout.CENTER);";
   ...
   public static void buildMain( DeclarationManager declMgr, String className )
   {
      MethodWriter method_writer = new MethodWriter( declMgr, null, "main" )
	 {
      ...
      Block block = new Block();
      String frame_code = "JFrame frame = new JFrame();" +
	 "frame.setSize(600, 400);" +
	 "frame.setLocation(100, 100);" +
	 "frame.getContentPane().add(new " + className + "());" +
	 "frame.setVisible(true);";
      ...
      String listener_code = "frame.addWindowListener( new WindowAdapter()" +
	 "{" +
