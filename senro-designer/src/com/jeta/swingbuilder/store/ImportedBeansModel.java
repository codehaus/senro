...
/**
 * This model contains the list of beans imported by the user for
 * the application.   It also includes all classpaths where these
 * beans are located.
 *
 * @author Jeff Tassin
 */
public class ImportedBeansModel implements Externalizable
{
   ...
   /**
    * @return a collection of ImportedBeanInfo objects that define the list
    * of imported Java beans defined by the user.
    */
   ...
   /**
    * @return the collection of urls (URL objects) that define the classpath where
    * the imported Java beans are found.
    */
