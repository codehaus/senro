 ...
 * @author Jeff Tassin
 */
public class ImportedBeanInfo implements Externalizable, RegisteredBean
{
   ...
   /**
    * This is a scaled version of the m_icon_memento icon. It is scaled to 16x16 pixels
    * if the icon_memento is not exactly 16x16.  We do this so it will fit on the toolbar.
    */
	 ...
	 if ( m_icon_memento != null )
	 {
	    ...
	    if ( ii != null )
	    {
		  ...
		  m_scaled_icon = ii;
	       ...
	       {
		  // we need to scale the image to fit 16x16 pixels if it is too big or too small
