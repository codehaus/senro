      ...
      public void actionPerformed(ActionEvent evt) {
         ...
         if (gc != null) {
            ...
            if (view != null) {
               ...
               ColumnSpec oldspec = view.getFormLayout().getColumnSpec(col);
               String newspec = javax.swing.JOptionPane.showInputDialog(m_frame, I18N
      ...
      public void actionPerformed(ActionEvent evt) {
         ...
         if (gc != null) {
            ...
            if (comp != null) {
               ...
               String newvalue = javax.swing.JOptionPane.showInputDialog(m_frame, I18N.getLocalizedMessage("Set Name"),
                        oldname);
               if (newvalue != null) {
      ...
      public void actionPerformed(ActionEvent evt) {
         ...
         if (gc != null) {
            ...
            if (view != null) {
               ...
               String newspec = javax.swing.JOptionPane.showInputDialog(m_frame, I18N.getLocalizedMessage("Row Spec:"),
                        oldspec.toString());
               if (newspec != null) {
