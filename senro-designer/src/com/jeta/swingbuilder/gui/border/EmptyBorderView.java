...
public class EmptyBorderView extends AbstractBorderView
{
   ...
   {
      EmptyBorderProperty bp = new EmptyBorderProperty( getInteger( EmptyBorderNames.ID_EMPTY_BORDER_TOP ),
							getInteger( EmptyBorderNames.ID_EMPTY_BORDER_LEFT ),
							getInteger( EmptyBorderNames.ID_EMPTY_BORDER_BOTTOM ),
							getInteger( EmptyBorderNames.ID_EMPTY_BORDER_RIGHT ) );
      setTitle( bp );
      return bp;
   }
