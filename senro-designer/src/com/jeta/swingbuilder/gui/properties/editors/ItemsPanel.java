...
/**
 * This class displays a panel that allows a user to add and arrange String objects
 * in a collection.
 *
 * @author Jeff Tassin
 */
public class ItemsPanel extends JETAPanel
{
   ...
   /**
    * Creates the list that displays the items in the collection we are editing.
    */
