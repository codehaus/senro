...
public class PropertyPaneContainer extends JETAPanel implements GridViewListener, PropertyEditorListener
{
    ...
    {
        /**
         * Handle case where the user has changed the bean name in the editor. We
         * need to update the name field in this case.
         */
    ...
    {
        /**
         * Handle the case where the user has typed a new name in the name_field.
         * If the user then clicks on a different component in the editor, we want
         * to update the name of the current component before doing anything else.
         */
        if (comp != m_current_comp) {
            updateBeanName();
        }
    ...
    private void updateBeanName(JETABean bean)
    {
        if (bean != null) {
            ...
            if(comp != null && !UIInspectorManager.get().hasCustomInspector(comp)) {
