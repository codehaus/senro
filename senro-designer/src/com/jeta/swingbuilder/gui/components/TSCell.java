...
/**
 * A cell is used in a TSStatusBar. It represents a single cell on the bar.
 * A bar is made up as follows:
 *     [cell1][cell2]...[cellN]
 *
 * @author Jeff Tassin
 */
...
{
   String          m_mask;  // this is a mask that represents the maximum size for this cell
                            // for example, if this cell represents a time, you could set the mask to 00:00:00
   Dimension       m_maxsize;

   /** flag indicating if this is the main cell.  The cell increases size with the status bar.  But, it
    * will never go below its mask size */
   ...
   /**
    * Sets this cell as the main cell on the status bar.  Only one cell can
    * be the main cell.  Setting more than one cell as main will lead to undefined behavior.
    */
