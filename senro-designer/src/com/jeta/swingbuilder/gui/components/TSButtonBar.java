...
public class TSButtonBar extends JETAPanel
{
   ...
   /**
    * A list of action listeners that get invoked when the user clicks on a button on the button bar.
    */
   ...
   /**
    * Adds a listener that get invoked when the user clicks on a button on the button bar.
    */
    ...
    * @param caption the text that appears in the button that will activate
    * this view
    * @param view the view that will be displayed for this button.
    */
   ...
   /**
    * Removes a listener from the list of listeners that gets invoked when the user clicks on a button on the button bar.
    */
   ...
   private void updateSettings()
   {
      ...
      m_selected_color = new Color(Math.max((int)(c.getRed()  *FACTOR), 0), 
      ...
      m_selected_border = BorderFactory.createCompoundBorder( BorderFactory.createEtchedBorder( javax.swing.border.EtchedBorder.LOWERED ),
								 BorderFactory.createEmptyBorder( 2, 2, 2, 2 ) );
   }
   ...
   static class ButtonBarView
   {
	 ...
	 return m_btn;
      ...
      /**
       * @return the view that is displayed in the ButtonBar when the view is selected
       */
