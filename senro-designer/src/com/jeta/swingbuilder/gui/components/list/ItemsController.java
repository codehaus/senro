...
public class ItemsController extends TableSupportHandler
{
   ...
   public class AddItemAction implements ActionListener
   {
      public void actionPerformed(ActionEvent evt)
      {
         ...
         JETADialog dlg = JETAToolbox.invokeDialog(view, m_view, I18N.getLocalizedMessage("Item Properties"),
						   (JComponent)view.getComponentByName(ListItemNames.ID_ITEM_LABEL) );
         if (dlg.isOk())
         {
