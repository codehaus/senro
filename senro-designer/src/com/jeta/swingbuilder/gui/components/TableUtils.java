...
public class TableUtils
{
   ...
   /**
    * Converts a table row the the corresponding model index.  
    * This is needed when the table is sorted.  If the table is not
    * sorted, the table index will equal the model index
    * @param table the table whose index to convert
    * @param index the table index to convert
   ...
   /**
    * Creates a panel that contains a table that can be sorted can be sorted.  The table
    * is scrollable and has automatically resized subsequent columns
    * @param model the data model for the table.  Don't send in a TableSorter here.
    * @param sortable if true, then we will return a table that has sortable columns.  This will
    * wrap the tablemodel with a TableSorter.
   ...
   /**
    * Creats a row header for the given table.  The row number is displayed
    * to the left of the table ( starting with row 1).
