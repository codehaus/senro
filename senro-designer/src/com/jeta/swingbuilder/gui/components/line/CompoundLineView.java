...
public class CompoundLineView extends JETAPanel
{
   ...
   /**
    * Creates a swing border based on the properties in this view and displays it.
    */
   public void updatePreview()
   {
      /*
      LineComponent lcomp = (LineComponent)m_view.getComponentByName( CompoundLineNames.ID_LINE_COMPONENT );
      lcomp.setLineDefinition( createLineProperty() );
      revalidate();
      doLayout();
      lcomp.repaint();
      */
   ...
   public static class LineInfo
   {
	 ...
	 if( m_icon == null || ( m_selected != selected) )
	 {
	    ...
	    //System.out.println( "CompoundLineView.getIcon  stroke thickness: " + s.getLineWidth() );
