...
/**
 * This view allows the user to configure how all the component
 * names for a given panel will be exported.
 *
 * @author Jeff Tassin
 */
public class ExportNamesView extends JETAPanel
{
   ...
   public static final String ID_INCLUDE_LINKED_FORMS = "included.linked.forms";
   ...
   public ExportNamesView()
   {
      ...
      m_view.setText( ID_DECORATOR_FIELD, TSUserPropertiesUtils.getString( ID_DECORATOR_FIELD, "public static final String ID_$identifier = \"$name\";  //$type" ) );
   }
