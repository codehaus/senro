...
public class FocusBox extends JPanel
{
   ...
   /**
    * A spinner box used to edit the current focus value. Only visible when this focusbox 
    * has 'focus' (i.e. the user clicked on this focusbox with the mouse
    */
   ...
   /**
    * Adds an action listener to this focusbox.  A call can get an action
    * event when the focus index changes or the user has clicked on this focus box.
    */
   ...
   public int getFocusIndex() { return m_index; }
   ...
   /**
    * @return the spinner component that is visible when the focus box has 'focus'.
    */
   JSpinner getSpinner()
   {
      if ( m_spinner == null )
   ...
   public static class FocusGlyph extends JComponent
   {
	 ...
	 m_background = background;
      ...
      public void setIndex( int index ) { m_index = index;  m_index_str = String.valueOf(index); }
