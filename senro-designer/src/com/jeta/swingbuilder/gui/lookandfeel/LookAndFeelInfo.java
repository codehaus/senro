...
public class LookAndFeelInfo 
{
   ...
   /**
    * The name of the look and feel theme.  Can be null for those LaFs that don't support themes.
    */
   ...
   /**
    * ctor
    * @param loaderClass the name of the class responsible for instantiating a specified look and
    * feel along with the specified theme.
    * @param lfClass the name of the look and feel class
    * @param lfTheme the name of a theme to apply to the look and feel.  Can be null.
    * @param lfName the name of the look and feel. This will be displayed in the application L&F menu.
    */
