 ...
 * depends on the user preferences.  It can either be a JFileChooser or
 * a TSFileChooser. The TSFileChooser is a more advanced dialog that follows
 * the Linux and Emacs type file selection.
 * 
 * @author Jeff Tassin
 */
public class TSFileChooserFactory
{
   ...
   public static File showOpenDialog( int mode, TSFileFilter filter )
   {
      ...
      //return showOpenDialog( mode, userprops.getProperty( LAST_DIRECTORY, null ), new TSFileFilter[] { filter} );
   }
