...
public class FormManagerDesignUtils {
   ...
   /**
    * Creates a clone of the given form component. This will also reset the id's
    * of all the embedded child forms and register the new forms with the form
    * manager
    */
   ...
   /**
    * @return the ids (as a Collection of Strings) of all nested forms contained
    *         in this component
    */
   ...
   /**
    * @return a set of all nested linked form ids (String objects) including the
    *         given form that are contained by the given form.
    */
   ...
   /**
    * Invokes a file chooser dialog which allows the user to select a form file.
    * The form file is then checked to determine if it lies on the valid source
    * path. If the form does not lie on a valid source path, an error dialog is
   ...
   public static File openLinkedFormFile() {
      ...
      if (f != null) {
         ...
         if (pmgr.isValidAbsolutePath(f.getPath())) {
            ...
            JOptionPane.showMessageDialog(FormManagerDesignUtils.getApplicationFrame(), msg, title,
