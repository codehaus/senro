...
/**
 * This class is the table model for the FormManagerView.  It gets
 * the list of forms from the FormManager and stores them in
 * this model.  This is mainly used to help debugging.
 * @author Jeff Tassin
 */
public class FormsModel extends AbstractTableModel
{
   ...
   public FormsModel()
   {
      ...
      String[] values = { I18N.getLocalizedMessage("Embedded"),
			  I18N.getLocalizedMessage("Form Id"),
			  I18N.getLocalizedMessage("Name"),
