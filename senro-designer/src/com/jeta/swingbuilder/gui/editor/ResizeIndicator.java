...
public class ResizeIndicator
{
   ...
   /**
    * The current position of the indicator relative to the top-level grid overlay
    */
    ...
    * @param size the value for the size
    * @param units the units (MM, CM, IN, DLU etc. )
    * @param viewOfffset the current position of the viewport (for rendering correctly while scrolling)
    */
