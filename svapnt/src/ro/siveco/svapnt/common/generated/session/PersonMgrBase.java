...
public abstract class PersonMgrBase extends ro.siveco.svapnt.common.session.PartnerMgrImpl
{
	public static <T> T getInstance() throws LookUpException
	{
		return (T) getInstance(ro.siveco.svapnt.common.session.PersonMgrLocal.JNDI_NAME);
	}
