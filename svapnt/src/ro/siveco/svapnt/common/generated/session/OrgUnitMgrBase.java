...
public abstract class OrgUnitMgrBase extends ro.siveco.svapnt.common.session.PartnerOrgUnitMgrImpl
{
	public static <T> T getInstance() throws LookUpException
	{
		return (T) getInstance(ro.siveco.svapnt.common.session.OrgUnitMgrLocal.JNDI_NAME);
	}
