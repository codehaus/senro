...
public abstract class EmployeeMgrBase extends ro.siveco.svapnt.common.session.PersonMgrImpl
{
	public static <T> T getInstance() throws LookUpException
	{
		return (T) getInstance(ro.siveco.svapnt.common.session.EmployeeMgrLocal.JNDI_NAME);
	}
