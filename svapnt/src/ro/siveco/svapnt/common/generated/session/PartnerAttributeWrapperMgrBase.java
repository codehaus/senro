...
public abstract class PartnerAttributeWrapperMgrBase extends ro.siveco.svapnt.common.session.GenericSessionImpl
{
	public static <T> T getInstance() throws LookUpException
	{
		return (T) getInstance(ro.siveco.svapnt.common.session.PartnerAttributeWrapperMgrLocal.JNDI_NAME);
	}
