package org.senro.metadata.graph;
...
/**
 * An implmentation of the classic Breadth-First Search algorithm from Corman et al.  This class builds a cache of all
 * the nodes of the graph that are reachable from the start Vertex that is passed in.
 *
